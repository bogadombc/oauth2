package com.mbogado.authserver.config;
...
public class AuthorizationServerConfig {
  ...
  // Configura a cadeia de filtros de segurança para os endpoints do Authorization
  // Server
  @Bean
  @Order(1)
  ...
  // Configura a cadeia de filtros de segurança para os endpoints padrão (ex:
  // /login, /logout) e demais rotas da aplicação
  @Bean
  @Order(2)
  ...
  // Configura um cliente OAuth2 para o Next.js (Auth.js)
  @Bean
  ...
  // Configura a fonte de chaves JWK para assinar os tokens JWT emitidos pelo
  ...
  // Configura o JwtDecoder para validar os tokens JWT usando a fonte de chaves
  // JWK
  @Bean
  ...
  // Configura as informações do Authorization Server, como o issuer (emissor) dos
  // tokens
  @Bean
